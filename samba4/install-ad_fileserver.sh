...
## install as an AD - Client
/bin/bash install-ad_client.sh

printAndLogMessage "INSTALL PACKAGES"
printAndLogMessage "apt-get install -y acl attr samba samba-dsdb-modules samba-vfs-modules bind9-dnsutils"
...
apt-get install -y acl attr samba samba-dsdb-modules samba-vfs-modules bind9-dnsutils
