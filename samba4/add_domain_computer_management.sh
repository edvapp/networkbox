...
samba-tool ou create ${OU_MANAGER_CONTAINER}

printAndLogMessage "CREATE CONTAINER DOMAIN COMPUTERS ${OU_DOMAIN_COMPUTERS_CONTAINER}"
samba-tool ou create ${OU_DOMAIN_COMPUTERS_CONTAINER}
