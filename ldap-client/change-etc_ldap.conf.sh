...
binddn cn=ldapread,dc=app,dc=net
...
nss_initgroups_ignoreusers backup,bin,daemon,games,gnats,irc,landscape,libuuid,list,lp,mail,man,news,ntp,openldap,proxy,root,sshd,statd,sync,sys,syslog,uucp,www-data
